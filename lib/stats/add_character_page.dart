...
class AddCharacterPage extends StatefulWidget {
  const AddCharacterPage({super.key, required this.dbService});
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        title: const Text("Add Character", style: AppDefaults.titleDark),
      ),
      body: Container(
              ...
              children: [
                ...
                createSlider(
                  RangeSlider(
                    ...
                    //labels: RangeLabels('${provider.hp.start.toString()}', '${provider.hp.end.toString()}'),
                          ...
                          actions: <Widget>[
                            ...
                            TextButton(
                              onPressed: () {
                                ...
                                // push to database
                                widget.dbService.addCharacter(newCharacter, newWeapon1, newWeapon2);
                                // pop out of alert
